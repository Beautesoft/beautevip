        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.rewardAndRedeemContainer}>
                    <TouchableOpacity onPress={() => { setShowRedeem(false) }} activeOpacity={1} style={styles.rewardButton}>
                        <Text style={[styles.rewardText, {
                            color: !showRedeem ? BaseColor.amberTxt : BaseColor.white
                        }]}>{t("reward")}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => { setShowRedeem(true) }} activeOpacity={1}
                ...
                </View>
                {
                    ...
                    <Text style={[styles.pointsText, { textAlign: "right", marginHorizontal: 16 }]}>{t("points")}</Text>
                }
                {
